                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="badge bg-secondary fs-7 px-2 py-2">{{ $archive->views }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div
                                            ...
                                            <a href="#" class="btn btn-sm btn-info view-archive" title="View"
                                                data-id="{{ $archive->id }}">
                                                <i class="fa fa-eye"></i>
                                            </a>
...
<script>
    $(document).on('click', '.view-archive', function(e) {
            ...
            let url = "{{ url('admin/archives') }}/" + archiveId;
