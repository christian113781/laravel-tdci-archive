            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('admin.manage.archive.page') }}" class="btn btn-primary btn-round ms-auto">
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('admin.archive.manage.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-control" id="program"
                                                        ...
                                                        <option value="{{ $dept->id }}" {{ $loop->first ? 'selected' :
                                                            '' }}>
                                                            {{ $dept->name }}
                                                        </option>
                                                        @empty
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="category" class="form-select form-control"
                                                        ...
                                                        <option value="A" {{ old('category', $archive->category ?? '')
                                                            === 'A' ? 'selected' : '' }}>
                                                            A. General</option>
                                                        <option value="B" {{ old('category', $archive->category ?? '')
                                                            === 'B' ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="select2-input select2-danger">
                                                        <select id="multiple" name="multiple[]"
                                                            ...
                                                            <option value="{{ $keyword->id }}" {{ in_array($keyword->id,
                                                                old('multiple', [])) ? 'selected' : '' }}>
                                                                {{ $keyword->name }}
                                                            </option>
                                                            @empty
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="authors" name="authors" rows="3"
                                                        required placeholder="Juan Delacruz"></textarea>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content" style="max-width: 900px; margin: auto;">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!-- PDF Viewer -->
                                    <iframe id="archivePdf" src="" width="100%" style="border:0; height:65vh;"></iframe>
                                </div>
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $archive->user->first_name ?? 'N/A' }}</td>
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <!-- Status Toggle -->
                                            <form
                                                action="{{ route('admin.archives.manage.updateStatus', $archive->id) }}"
