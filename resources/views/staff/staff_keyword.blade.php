                                    ...
                                    <td>
                                        <div
                                            ...
                                            <form id="delete-form-{{ $keyword->id }}"
                                                action="{{ route('staff.keyword.destroy', $keyword->id) }}"
    ...
    $(document).ready(function() {
            ...
            @if ($errors->any())
                ...
                @if ($oldMethod === 'PUT')
                    ...
                    document.getElementById('keywordForm').action = `/staff/keyword/${oldKeywordId}`;
                ...
                @else
                    document.getElementById('keywordForm').action = '{{ route('staff.keyword.store') }}';
        ...
        function openEditModal(id, name) {
            document.getElementById('keywordForm').action = `/staff/keyword/${id}`;
            document.getElementById('formMethod').value = 'PUT';
