        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="GET" action="{{ route('patron.archive') }}">
...
@push('script')
    ...
    <script>
        $(document).on('click', '.view-archive', function(e) {
            ...
            let url = "{{ url('patron/archives') }}/" + archiveId + "/view";
...
`;
        ...
        $(document).on('click', '.requestAccessBtn', function(e) {
            ...
            $.ajax({
                url: "/patron/archive/request-access/" + archiveId, // pass archiveId in URL
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}"
                },
