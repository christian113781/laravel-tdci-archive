        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('patron.profile.update') }}" enctype="multipart/form-data"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" id="firstname" name="first_name"
                                        placeholder="Enter Firstname" value="{{ old('first_name', $user->first_name) }}"
                                        required>
                                    @error('first_name')
                            ...
                            <div class="form-group form-show-validation row">
                                <label for="password_confirmation"
                                    class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-end">Confirm Password</label>
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <div class="input-file input-file-image">
                                        <img id="preview-image" class="img-upload-preview img-circle mb-2" width="100"
                                            height="100"
                                            @if ($user->avatar) src="{{ asset('storage/' . $user->avatar) }}"
                                 @else
                                     src=" {{ asset('assets/img/profile.jpg') }}" @endif
                                            alt="preview">
                        ...
                        <div class="card-action">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="{{ route('patron.archive') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </div>
