...
class AdminControllerArchiveManage extends Controller
{
    public function index()
    {
        // Fetch all archives for admin, or only user's archives for staff
        ...
        return view('admin.admin_archive_manage', compact('archives', 'programs', 'keywords', 'archiveCode'));
    }
    ...
    public function storeArchive()
    {
        ...
        return view('admin.admin_archive_new', compact('nextCode', 'programs', 'keywords'));
    }
...
if (!file_exists($fullPath)) {
    ...
    public function edit($id)
    {
        ...
        return view('admin.admin_archive_edit', compact('archive', 'programs', 'keywords'));
    }
